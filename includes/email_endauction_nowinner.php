...
if ($emailmode == 'one')
{
	...
	$emailer->assign_vars(array(
			...
			'A_PICURL' => (!empty($Auction['pict_url'])) ? $system->SETTINGS['siteurl'] . $uploaded_path . $Auction['id'] . '/' . $Auction['pict_url'] : $system->SETTINGS['siteurl'] . 'images/email_alerts/default_item_img.jpg',
