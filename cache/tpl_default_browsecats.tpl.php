...
<?php if ($this->_rootref['NUM_AUCTIONS'] > 0) {  if ($this->_rootref['ID'] > 0) {  ?>
		...
		<table width="98%" border="0" cellspacing="0" cellpadding="4" class="catsearch">
			<tr>
				<td><input type="text" title="<?php echo ((isset($this->_rootref['L_30_0070'])) ? $this->_rootref['L_30_0070'] : ((isset($MSG['30_0070'])) ? $MSG['30_0070'] : '{ L_30_0070 }')); ?>" size="40" maxlength="60" placeholder="<?php echo ((isset($this->_rootref['L_30_0070'])) ? $this->_rootref['L_30_0070'] : ((isset($MSG['30_0070'])) ? $MSG['30_0070'] : '{ L_30_0070 }')); ?>" name="catkeyword" size="20">&nbsp;<input type="submit" name="" value="<?php echo ((isset($this->_rootref['L_103'])) ? $this->_rootref['L_103'] : ((isset($MSG['103'])) ? $MSG['103'] : '{ L_103 }')); ?>" class="button">
